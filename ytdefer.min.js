...
var ytdefer_ic_w=73;var ytdefer_ic_h=52;function ytdefer_setup()
...
var w=e.clientWidth;var h=e.clientHeight;var dv=d.createElement('div');dv.id='ytdefer_vid'+i;dv.style.width=w+'px';dv.style.height=h+'px';dv.style.position='relative';dv.onresize=ytdefer_resize;e.appendChild(dv);var im=d.createElement('img');im.src='https://img.youtube.com/vi/'+ds+'/0.jpg';im.id='ytdefer_img'+i;im.style.width='100%';im.style.height='100%';im.style.objectFit='cover';im.style.position='absolute';im.onclick=gen_ytdefer_clk(i);dv.appendChild(im);var im2=d.createElement('img');im2.src='yt_blk.png';im2.id='ytdefer_icon'+i;im2.style.position='absolute';im2.style.left=(w/2-ytdefer_ic_w/2)+'px';im2.style.top=(h/2-ytdefer_ic_h/2)+'px';im2.style.width=ytdefer_ic_w+'px';im2.style.height=ytdefer_ic_h+'px';im2.style.pointerEvents='none';dv.appendChild(im2);im.onmouseover=gen_mouseover(im2);im.onmouseout=gen_mouseout(im2);}
